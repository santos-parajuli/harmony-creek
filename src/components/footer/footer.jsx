...
export default function Footer() {
	...
	return (
		<footer className='mt-10 bg-muted text-foreground dark:bg-muted dark:text-muted-foreground lg:text-left'>
			{/* Weather Widget */}
			...
			<div className='flex flex-col gap-4 items-center justify-between border-b-2 border-border dark:border-border px-6 py-6 md:flex-row'>
				...
				<div className='flex gap-6'>
					<Link href='https://www.facebook.com/profile.php?id=100057232549144' target='_blank' aria-label='Facebook'>
						<Facebook className='h-5 w-5 hover:text-primary dark:hover:text-primary transition' />
					</Link>
					<Link href='https://www.instagram.com/harmonycreekgolfcentre/' target='_blank' aria-label='Instagram'>
						<Instagram className='h-5 w-5 hover:text-accent dark:hover:text-accent transition' />
					</Link>
					<Link href='https://harmonycreekgolf.com' target='_blank' aria-label='Website'>
						<Globe className='h-5 w-5 hover:text-chart-3 dark:hover:text-chart-3 transition' />
					</Link>
				</div>
			</div>
				...
				<div className='grid gap-10 md:grid-cols-6 grid-cols-2'>
					...
					<div>
						...
						<ul className='space-y-2 text-sm'>
							...
							<li>
								<Link href='/golf-facilities' className='hover:text-primary dark:hover:text-primary'>
									Golf Facilities
								</Link>
							</li>
							<li>
								<Link href='/banquet-hall' className='hover:text-primary dark:hover:text-primary'>
									Banquet Hall
								</Link>
							</li>
						</ul>
					...
					<div>
						...
						<ul className='space-y-2 text-sm'>
							<li>
								<Link href='/map-directions' className='hover:text-primary dark:hover:text-primary'>
									Map & Directions
								</Link>
							</li>
							<li>
								<Link href='/contact-us' className='hover:text-primary dark:hover:text-primary'>
									Contact
								</Link>
							</li>
							<li>
								<Link href='/careers' className='hover:text-primary dark:hover:text-primary'>
									Careers
								</Link>
							</li>
							<li>
								<Link href='/accessibility' className='hover:text-primary dark:hover:text-primary'>
									Accessibility
								</Link>
							</li>
						</ul>
			...
			{/* Bottom Bar */}
			<div className='bg-muted dark:bg-muted py-4 text-center text-sm'>
				&copy; {new Date().getFullYear()} Harmony Creek Golf | Developed by{' '}
				<Link href='https://siwani.com.np/' target='_blank' className='font-semibold hover:text-primary dark:hover:text-primary'>
					Santosh Parajuli
				</Link>
			</div>
		</footer>
