	...
	return (
		<section className='mx-auto max-w-6xl px-6 py-20'>
			...
			<motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} viewport={{ once: false }} className='text-center mb-12'>
				<h2 className='text-3xl md:text-4xl font-bold text-gray-900 dark:text-gray-100'>Why Choose Harmony Creek?</h2>
				<p className='mt-4 text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto'>At Harmony Creek Golf Centre, we blend championship-level golf with exceptional hospitality to create unforgettable experiences.</p>
			</motion.div>
			...
			<motion.div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} viewport={{ once: false }} className='grid gap-8 md:grid-cols-2 md:items-center mb-16'>
				<div className='order-2 md:order-1'>
					...
					<p className='text-gray-600 dark:text-gray-300 leading-relaxed'>From elegant weddings in our acclaimed Harmony Hall to high-energy corporate tournaments, we deliver:</p>
			...
			<motion.div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} viewport={{ once: false }} className='grid gap-8 md:grid-cols-2 md:items-center'>
				...
				<div>
					...
					<p className='mt-4 text-gray-700 dark:text-gray-200 font-medium'>Where every detail is crafted for excellence—on the course and beyond. ⛳🍽️</p>
					<Button asChild className='mt-4'>
						<a href='https://harmony-creek-golf-centre.book.teeitup.golf' target='_blank' rel='noopener noreferrer'>
							Book Now
						</a>
